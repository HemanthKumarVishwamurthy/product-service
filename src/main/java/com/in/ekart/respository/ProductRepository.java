...
public interface ProductRepository extends CrudRepository<ProductEntity, Long> {
	...
	// @Query(value ="Select pe from ProductEntity pe where upper(pe.name) like :name") //HQL
	 // List<ProductEntity>  findAllByNameIgnoreCaseLikeOrderByPriceAsc(String name);
